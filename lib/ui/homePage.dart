...
Weather currentTemp = '' as Weather;
Weather tomorrowTemp = '' as Weather;
List<Weather> todayWeather = '' as List<Weather>;
List<Weather> sevenDay = '' as List<Weather>;
String lat = "6.5854";
String lon = "79.9607";
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: GlowContainer(
        ...
        glowColor: Color(0xFF7BE799).withOpacity(0.5),
        borderRadius: BorderRadius.only(
            bottomLeft: Radius.circular(60), bottomRight: Radius.circular(60)),
        color: Color(0xFF7BE799),
        spreadRadius: 5,
        child: Column(
          children: [
            Container(
